...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head><link rel="shortcut icon" href="favicon.ico" />
    ...
    <style type="text/css">
        <ExtensionCSS name="HighScoreTable"/>
    </style>

    <title>Highscore Tabelle für <CourseName />, <Semester /></title>
  </head>
  ...
  <body>
    ...
    <ExtensionCode name="HighScoreTable" entries="20"/>

...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Ergebnisabfrage</title>
  </head>

  <body>
    <Header />
    <h1>Ergebnisabfrage</h1>

    <h2>Vorlesung: <CourseName />, <Semester />, <Lecturer /></h2>

<p>Hier können Sie Ihre Punktzahl für Ihre Lösungen zu denjenigen
Blättern abrufen, deren Abgabefrist bereits abgelaufen ist.</p>

<p>Bitte geben Sie Ihre Matrikelnummer und Ihr Passwort ein 
(Noch nicht <a href="/registration.html">angemeldet</a>?):</p> 
...
<!-- Copyright 2003 Frank Lübeck and Max Neunhöffer
     $Id: resquery.tpl,v 1.3 2004/10/05 09:04:20 neunhoef Exp $ -->

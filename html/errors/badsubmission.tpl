...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Fehler: Probleme bei der Abgabe</title>
  </head>
  ...
  <body>
    ...
    <p>Ihre Abgabe konnte nicht erfolgreich bearbeitet werden. Dies ist
       entweder auf einen Programmfehler oder auf eine Manipulation von
       außen zurückzuführen.</p>
    <p>Bitte kontaktieren Sie den Systemadministrator und schildern Sie
       den Fall.</p>

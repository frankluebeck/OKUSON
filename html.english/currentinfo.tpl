...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    <p>On this page I publish current announcements. </p>

    <h3>New time for the tutorial</h3>

    <p>The time for the tutorial is Tuesdays 4pm to 5pm in Theatre A.
    </p>
...
<!-- Copyright 2003 Frank Lübeck and Max Neunhöffer
     $Id: currentinfo.tpl,v 1.4 2004/10/06 10:26:44 neunhoef Exp $ -->

...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head><link rel="shortcut icon" href="favicon.ico" />
    ...
    <title>Error: Unknown group</title>
  </head>

  <body>
    <Header />
    <h1>Error: Unknown group</h1>

    <p>There is no group with this number.
    </p>
...
<!-- Copyright 2003 Frank Lübeck and Max Neunhöffer
     $Id: unknowngroup.tpl,v 1.4 2004/10/06 10:26:44 neunhoef Exp $ -->

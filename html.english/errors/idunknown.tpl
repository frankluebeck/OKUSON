...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head><link rel="shortcut icon" href="favicon.ico" />
    ...
    <title>Error: ID unknown</title>
  </head>

  <body>
    <Header />
    <h1>Error: ID unknown</h1>

    <p>Nobody has registered using this ID.
    </p>

    <p>Please register first under the menu item "Registration" in the
       main menu or

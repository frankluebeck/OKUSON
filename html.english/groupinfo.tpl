...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head><link rel="shortcut icon" href="favicon.ico" />
    ...
    <title>Exercise group information</title>
  </head>

  <body>
    <Header />
    <h1>Exercise group information</h1>

    <h2>Course: <CourseName />, <Semester />, <Lecturer /></h2>

    <p><strong>Number of exercise group:&nbsp;&nbsp;</strong><GroupNumber/></p>
    <p><strong>Tutor:&nbsp;&nbsp;</strong><GroupTutor/></p>
    <p><strong>Place:&nbsp;&nbsp;</strong><GroupPlace/></p>
    <p><strong>Time:&nbsp;&nbsp;</strong><GroupTime/></p>
    <p><strong>Email of tutor:&nbsp;&nbsp;</strong><GroupEmailTutor/></p>
    <p><strong>IDs of participants:&nbsp;&nbsp;</strong><br />
    <GroupIDs/>
    </p>

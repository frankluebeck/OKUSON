...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head><link rel="shortcut icon" href="favicon.ico" />
    ...
    <title>Your change of data was successful</title>
  </head>

  <body>
    <Header />
    <h1>Your change of data was successful</h1>

    <p>Your change of data query was performed successfully.</p>
...
<!-- Copyright 2003 Frank Lübeck and Max Neunhöffer
     $Id: regchsuccess.tpl,v 1.4 2004/10/06 10:26:44 neunhoef Exp $ -->
